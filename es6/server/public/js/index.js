...
/***/ (function(module, exports, __webpack_require__) {
	...
	function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } } //兼容IE8等不支持es5的浏览器
	...
	var Base = function () {
	    ...
	    _createClass(Base, [{
	        ...
	        value: function getCount() {
	            ...
	            var tpl = void 0;
	            var c1 = win1 < 0 && win2 < 0 ? Math.abs(win1) : win1; //如果都亏损了,保存亏损的钱
	        ...
	        value: function getRandom(num) {
	            var arr = [],
	                index = void 0;
	            var number = Array.from(this.number); //.from()把一个集合转成数组
	            while (num--) {
	    ...
	    _createClass(Timer, [{
	        ...
	        value: function countdown(end, update, handle) {
	            ...
	            if (now - end > 0) {
	                ...
	                var px_d = 1000 * 60 * 60 * 24; //设计一个常量,算出一天的秒数
	                var px_h = 1000 * 60 * 60;
	                var px_m = 1000 * 60;
	                var px_s = 1000;
	                var d = Math.floor(last_time / px_d); //向下舍入取整
	...
	var Calculate = function () {
	    ...
	    _createClass(Calculate, [{
	        ...
	        value: function computeCount(active, play_name) {
	            ...
	            var arr = new Array(active).fill('0'); //指定长度为active的美国元素默认为0的数组.
	...
	var Interface = function () {
	    ...
	    _createClass(Interface, [{
	        ...
	        value: function getOpenCode(issue) {
	            var self = this;
	            return new Primise(function (resolve, rejet) {
	                _jquery2.default.ajax({
	                    url: '/get/opencode',
	                    data: {
	                        issue: issue
