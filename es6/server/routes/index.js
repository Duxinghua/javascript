...
var makeIssue = function(){
	...
	if(date.getTime()-first_issue_date.getTime()>0&& date.getTime()-end_issue_date.getTime()<0){
		...
		cur_issue = [end_dategetFullYear(),('0'+end_date.getMonth()+1).slice(-2),('0'+end_date.get),('0'+end_date.getDate()).slice(-2),('0'+h).slice(-2)].join('');
